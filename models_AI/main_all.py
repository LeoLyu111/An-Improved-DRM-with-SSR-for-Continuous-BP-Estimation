...
def add_arguments(parser):
    ...
    parser.add_argument("--num_bi_layers", type=int, default=2,
                        help="number of bidirectional layers, 1 layer acually represent 2 directions")
    parser.add_argument("--num_uni_layers", type=int, default=6,
    ...
    parser.add_argument('--day1_only', type="bool", default=True,
    ...
    parser.add_argument('--remove_outlier_from_loss_in_test', type="bool", default=True,
    ...
    parser.add_argument("--src_feature_size", type=int, default=13,
    ...
    parser.add_argument("--stage", type=str, default='train_eval_test',
                        help=("['preprocess', 'train_eval', 'test', 'train_eval_test']."
                              ))
...
def check_and_save_hparams(out_dir, hparams):
    ...
    if tf.io.gfile.exists(hparams_file):
        with codecs.getreader("utf-8")(tf.io.gfile.GFile(hparams_file, "rb")) as f:
            ...
            origin_hparams = HParams(**origin_hparams)
        wrong_keys = []
...
def main():
    ...
    # print(hparams.dataset_sheme)
    # check GPU device
    # utils.print_out("# Devices visible to TensorFlow: %s" % tf.config.list_physical_devices('GPU'))
    #  create dirs
    ...
    if stage == "train_eval_test":
        while (1):
            ...
            print(global_step,hparams.num_train_steps)
